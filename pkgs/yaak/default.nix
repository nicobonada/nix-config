# Local pin of nixpkgs PR 548416 (yaak 2025.6.1 → 2026.5.0).
# nixpkgs is still on 2025.6.1; AppImage failed here (EGL). Drop this when
# unstable has ≥ 2026.5.0.
{
  lib,
  rustPlatform,
  cargo-tauri,
...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-DkyByZ4RCYE2aE+aoTdKB0Yn3hJshEuKhog0XI50H1M=";
  };

  npmDeps = fetchNpmDeps {
    inherit (finalAttrs) src patches;
    hash = "sha256-lzJ29IIQQBl/uq7kt3u9PexKSOHR7+qUUxMvTaK4LMw=";
    fetcherVersion = 2;
  };

  cargoHash = "sha256-pDso0/arHuTKE3ifCKZ9tommPt97v6sf75I05cOMQZQ=";

  cargoRoot = ".";
  buildAndTestSubdir = "crates-tauri/yaak-app-client";

  patches = [ ./nanoid-lock.patch ];
